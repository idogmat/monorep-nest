...
export class PaymentsService {
  ...
  async updatePayment(subscriptionId, product) {
  ...
  async activateSubscribe(customer, product, userId) {
  ...
  async deletePayment(userId, paymentId) {
    ...
    return this.stripeAdapter.deleteSubscription(payment.subscriptionId);
  }
