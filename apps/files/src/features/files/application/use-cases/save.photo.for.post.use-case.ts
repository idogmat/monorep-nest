...
export class SavePhotoForPostUseCase
  implements ICommandHandler<SavePhotoForPostCommand>
{
  constructor(private readonly localPathRepository: LocalPathRepository) {}
        ...
        command.stream.subscribe({
          next: ({ chunkData, filename, userId, postId }) => {
            try {
              ...
              this.localPathRepository.createLocalPath({
                userId,
                postId,
                entity: 'post',
              });
