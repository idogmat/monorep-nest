...
export class GateService {
  ...
  async filesServicePost(path, payload, headers) {
    const response = await lastValueFrom(
      this.httpService.post([this.fileService, path].join('/'), payload, {
        headers,
      }),
    );
  ...
  async postServicePost(path, payload, headers) {
    const response = await lastValueFrom(
      this.httpService.post([this.postService, path].join('/'), payload, {
        headers,
      }),
    );
    return response;
  ...
  async postServicePut(path, payload, headers) {
    const response = await lastValueFrom(
      this.httpService.put([this.postService, path].join('/'), payload, {
        headers,
      }),
    );
    return response;
  ...
  async postServiceDelete(path: string, headers) {
    const response = await lastValueFrom(
      this.httpService.delete([this.postService, path].join('/'), {
        headers,
      }),
    );
    return response;
