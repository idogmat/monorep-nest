...
var mt,
  ...
  Ko = ge(() => {
    ...
    I.times = I.mul = function (e) {
      ...
      for (; !o[--s]; ) o.pop();
      return (
        t ? ++r : o.shift(), (e.d = o), (e.e = r), W ? V(e, C.precision) : e
      );
    };
...
var St = class {
  ...
  json(t) {
    return (
      aa(this._client), this._client._engine.metrics({ format: 'json', ...t })
    );
  }
};
c();
...
function Ot(e = {}) {
  ...
  return Object.entries(t).reduce(
    (n, [i, o]) => (
      ya[i] !== void 0 ? (n.select[i] = { select: o }) : (n[i] = o), n
    ),
    { select: {} },
  );
}
...
async function pf(e, t) {
  ...
  if (o !== void 0 || n === '0.0.0' || n === 'in-memory') {
    ...
    try {
      ...
      throw (
        (console.error('JSON.parse error: body fetched from unpkg.com: ', S), _)
      );
    }
    return R.version;
  }
