...
import {
  ...
  Subscription,
  Prisma,
} from '../../../prisma/generated/profile-client';
...
export type ProfileWithSubscribers = Profile &
  Prisma.ProfileGetPayload<typeof profileWithSubscribers>;
export type ProfileWithSubscribersGql = Subscription &
  Prisma.SubscriptionGetPayload<typeof profileWithSubscribersGql>;
...
export const OutputProfileModelMapper = (
  profile: ProfileWithSubscribers,
  _userId?: string,
): OutputProfileModel => {
  // console.log(profile)
...
export const OutputProfileUpdateModelMapper = (
  profile: Profile,
...
const getCount = (
  array:
    | ProfileWithSubscribers['subscribers']
    | ProfileWithSubscribers['subscriptions'],
) => array.length;

const followedCheck = (
  array: ProfileWithSubscribers['subscribers'],
  id: string = '',
) => Boolean(array.find((e) => e?.subscriberId === id));
